...
import 'package:flutterrecipes/models/recipe_model.dart';
import 'package:flutterrecipes/views/recipe_view.dart';
...
class _HomeState extends State<Home> {
  List<RecipeModel> recipies =  List();
  String ingridients;
  bool _loading = false;
  String query = "";
      ...
      body: Stack(
        children: <Widget>[
          ...
          SingleChildScrollView(
            child: Container(
              padding: EdgeInsets.symmetric(vertical: Platform.isAndroid? 60: 30 , horizontal: 24),
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "What are you gonna to cook today?",
                    style: TextStyle(
                        fontSize: 20,
                        color: Colors.white,
                  ...
                  Text(
                    "Just Enter Ingredients and we will show you how to cook it",
                    style: TextStyle(
                        fontSize: 15,
                        color: Colors.white,
